            ...
            message: {
                ...
                body: {
                    ...
                    content: `
                        ...
                        <p>To make staying informed and connected easier, we’ve developed an app just for you. With our app, you’ll have access to:</p>
                        <ul>
                        ...
                        <p>Thank you for trusting us to be a part of this important journey. If you have any questions or need assistance setting up the app, don’t hesitate to reach out.</p>
                        <p>We look forward to working together and making a positive impact!</p>
                        <p>From ${staff_name}</p>
                    `,
                },
                toRecipients: [
